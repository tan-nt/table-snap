...
train_lrcs_path = [
    ...
    # "./dataset/SciTSR_ocr/train/table.lrc"
]
train_data_dir = ''
...
cpu_valid_batch_size = 1            # ↓ from 16 → prevents memory/index overflows
gpu_valid_batch_size = 4
gpu_mps_valid_batch_size = 8
...
gpu_mps_max_iters_per_epoch = 1000 # run all
gpu_max_iters_per_epoch = 1000000 # run all


cpu_max_valid_iters = 10
gpu_mps_max_valid_iters = 10
