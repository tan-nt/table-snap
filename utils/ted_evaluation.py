...
class TEDS(object):
    ...
    def evaluate(self, pred, true):
        ...
        # Use the first table, or the whole root if body/table is missing
        pred_table = pred.xpath("body/table")
        true_table = true.xpath("body/table")
        pred = pred_table[0] if pred_table else pred
        true = true_table[0] if true_table else true
        ...
        distance = apted.APTED(tree_pred, tree_true, CustomConfig()).compute_edit_distance()
        return 1.0 - (float(distance) / n_nodes) if n_nodes else 0.0
...
def test_ted_evaluation():
    teds = TEDS(structure_only=True)
    # pred = "<table><tr><td>1</td><td>2</td></tr><tr><td>3</td><td>4</td></tr></table>"
    # true = "<table><tr><td>1</td><td>2</td></tr><tr><td>3</td><td>4</td></tr></table>"
    pred = "<body><table><tr><td>1</td><td>2</td></tr><tr><td>3</td><td>4</td></tr></table></body>"
    true = "<body><table><tr><td>1</td><td>2</td></tr><tr><td>3</td><td>4</td></tr></table></body>"
